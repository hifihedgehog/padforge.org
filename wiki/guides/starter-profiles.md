...
that turns into a hold no longer stops playback.

The one controller this does not reach is a pad whose driver profile has
no Guide button at all. There is no second gesture for those, because
every other pair of buttons is already spoken for in at least one profile,
and taking one back is the thing this design exists to avoid.
